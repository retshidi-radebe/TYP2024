<%@ Page Title="" Language="C#" MasterPageFile="~/VetMaster.Master" AutoEventWireup="true" CodeBehind="AllocatefromVet.aspx.cs" Inherits="Farmacy_App.AllocatefromVet" Async="true" %>
                        ...
                        <div class="card-body">
                                ...
                                <div class="panel-body">
                                    <div class="table-responsive">
                                        ...
                                        <a href="AddMedication.aspx">Add New Medication</a>
                                           <%-- <asp:Button ID="btnNewmed" style="border: 0px; background-color: white;" runat="server" Text="Add New Medication" OnClick="NewMed_Clicked" />--%>
