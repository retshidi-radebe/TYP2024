...
namespace Farmacy_App
{
    public partial class AddMedication : System.Web.UI.Page
    {
        ...
        string animalIdString;
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {

                animalIdString = Request.QueryString["id"];
            }
        }
        ...
        protected async void AddAnimal_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    error.Text = "Medication has been added successfully!";
                }
                else
                {
        ...
        private async Task<HttpResponseMessage> RegisterMedAsync(object user)
        {
            ...
            return await client.PostAsync("http://localhost:7041/api/Farmacy/AddMedication", content);
        }
    }
}