...
<%@ Page Title="" Language="C#" MasterPageFile="~/NavMenu.Master" AutoEventWireup="true" CodeBehind="EditAnimal.aspx.cs" Inherits="Farmacy_App.EditAnimal" Async="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container">
     ...
     <Label style="color: #0043a6;font-weight:normal;">Please fill in the form below to edit animal:</Label>
    <div class="row">
...
<asp:ListItem Text="Quarantine" Value="4"></asp:ListItem>
 <asp:ListItem Text="FMD confirmed" Value="5"></asp:ListItem>
            ...
            <asp:Button ID="editAnimal"  runat ="server" Text="Edit Animal" OnClick="EditAnimal_Click" class="btn btn-primary"/> 
