<%@ Page Title="" Language="C#" MasterPageFile="~/WorkerMenu.Master" AutoEventWireup="true" CodeBehind="WorkerDashboard.aspx.cs" Inherits="Farmacy_App.WorkerDashboard" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="Dashboard.aspx">Worker</a></li>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xxl-4 col-xl-12">
                                ...
                                <div class="card info-card customers-card">
                                    ...
                                    <div class="card-body">
                                        <h5 class="card-title">Workers <span>| This Year</span></h5>
