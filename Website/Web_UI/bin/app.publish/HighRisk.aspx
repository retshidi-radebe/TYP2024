<%@ Page Title="" Language="C#" MasterPageFile="~/NavMenu.Master" AutoEventWireup="true" CodeBehind="HighRisk.aspx.cs" Inherits="Farmacy_App.HighRisk"  Async="true"%>
        ...
        <section class="section dashboard" id="header">
            <div class="row">
                <div class="col-lg-10">
                 ...
                 <h2 style="color: #0043a6">High Risk Animals</h2>
                 <div class="panel panel-default">
                     <div class="panel-heading">
                         <span>Highrisk Animals Today</span>
                     </div>
